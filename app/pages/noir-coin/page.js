  ...
  return (
    <>
      ...
      <section className="relative bg-scroll text-center bg-cover bg-bottom bg-no-repeat py-10" style={{ backgroundImage: 'url(/nft.jpg)' }}>
        ...
        <div className="relative z-8 px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-5xl font-bold text-white">Noir Coin® & NFTs</h1>
          <p className="text-lg sm:text-2xl text-white mt-4">Earn exclusive rewards by engaging with our platform</p>
        </div>
      </section>

      <h2 className="text-center pt-1 pb-2 bg-slate-800 text-3xl sm:text-4xl text-slate-400 tracking-wider font-medium">
        <Link href="https://nft-noir.netlify.app/" className="underline hover:text-slate-200">
          FOR EVERY GAME OVER THERE'S A "PLAY AGAIN"
        </Link> 🕹️
      </h2>
      ...
      <section className="py-20 bg-gray-900 text-center text-white" style={{ background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 1)), url('/bg0.jpeg') no-repeat center center / cover" }}>
        <h2 className="text-yellow-300 text-3xl sm:text-4xl mb-10 font-bold tracking-wide font-serif">Ways to Earn NFTs and Noir Coin®</h2>
        <div className="text-left max-w-4xl mx-auto space-y-10 px-4 sm:px-6 lg:px-8">
          <div className="p-6 rounded-lg shadow-md" style={{ background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url('/achieve.jpg') no-repeat center center / cover" }}>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-blue-300">1. Game Achievements</h3>
            <p className="text-gray-100">Complete specific achievements and milestones in various games to earn rewards.</p>
            <ul className="list-disc list-inside ml-6 mt-4 text-gray-200 space-y-2">
          ...
          <div className="p-6 rounded-lg shadow-md" style={{ background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/tournament.jpg') no-repeat center center / cover" }}>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-green-300">2. Tournaments</h3>
          ...
          <div className="p-6 rounded-lg shadow-md" style={{ background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/community.jpg') no-repeat center center / cover" }}>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-red-300">3. Community Engagement</h3>
          ...
          <div className="p-6 rounded-lg shadow-md" style={{ background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/challange.jpg') no-repeat center center / cover" }}>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-yellow-400">4. Special Challenges and Quests</h3>
            <p className="text-gray-300">Complete weekly and monthly challenges tailored for each game to earn rewards.</p>
            <ul className="list-disc list-inside ml-6 mt-4 text-gray-400 space-y-2">
      ...
      <section className="py-20 bg-gray-900 text-center">
        <h2 className="text-3xl sm:text-4xl mb-10 text-white">Redemption and Marketplace</h2>
        <div className="text-left max-w-4xl mx-auto text-white space-y-10 px-4 sm:px-6 lg:px-8">
          <div>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4">NFT Redemption</h3>
            <p>NFTs earned can be viewed and managed in your profile. Use the marketplace to trade, sell, or buy additional NFTs.</p>
          </div>

          <div>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4">Noir Coin® Redemption</h3>
